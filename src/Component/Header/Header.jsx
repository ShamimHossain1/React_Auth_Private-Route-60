        ...
        <div>
            <div className="navbar bg-primary text-primary-content flex justify-between lg:px-28 px-3">
                ...
                <div className='lg:pr-52'>
                    ...
                    {user && <Link to='/orders' className="btn btn-ghost normal-case lg:text-xl">Orders  </Link>}
                    {user && <Link to='/profile' className="btn btn-ghost normal-case lg:text-xl">Profile  </Link>}
